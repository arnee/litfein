...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Form'
        db.create_table(u'form_designer_form', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('config_json', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'form_designer', ['Form'])

        # Adding model 'FormField'
        db.create_table(u'form_designer_formfield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'form_designer', ['FormField'])

        # Adding unique constraint on 'FormField', fields ['form', 'name']
        db.create_unique(u'form_designer_formfield', ['form_id', 'name'])

        # Adding model 'FormSubmission'
        db.create_table(u'form_designer_formsubmission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'form_designer', ['FormSubmission'])


    def backwards(self, orm):
        # Removing unique constraint on 'FormField', fields ['form', 'name']
        db.delete_unique(u'form_designer_formfield', ['form_id', 'name'])

        # Deleting model 'Form'
        db.delete_table(u'form_designer_form')

        # Deleting model 'FormField'
        db.delete_table(u'form_designer_formfield')

        # Deleting model 'FormSubmission'
        db.delete_table(u'form_designer_formsubmission')
    ...
    models = {
        ...
        u'form_designer.formfield': {
            ...
            'form': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fields'", 'to': u"orm['form_designer.Form']"}),
        ...
        u'form_designer.formsubmission': {
            'Meta': {'ordering': "('-submitted',)", 'object_name': 'FormSubmission'},
            'data': ('django.db.models.fields.TextField', [], {}),
            'form': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'submissions'", 'to': u"orm['form_designer.Form']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
