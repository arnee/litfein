...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'page_page_formcontent', (
            ...
            (u'parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'formcontent_set', to=orm['page.Page'])),
    ...
    models = {
        ...
        u'page.page': {
            ...
            u'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 0, 0)'}),
