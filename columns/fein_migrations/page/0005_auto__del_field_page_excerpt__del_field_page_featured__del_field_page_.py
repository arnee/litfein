...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Page.publication_end_date'
        db.delete_column(u'page_page', u'publication_end_date')

        # Deleting field 'Page.publication_date'
        db.delete_column(u'page_page', u'publication_date')

        # Deleting field 'Page._page_title'
        db.delete_column(u'page_page', u'_page_title')

        # Deleting field 'Page._content_title'
        db.delete_column(u'page_page', u'_content_title')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Page.publication_end_date'
        db.add_column(u'page_page', u'publication_end_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.publication_date'
        db.add_column(u'page_page', u'publication_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 27, 0, 0)),
                      keep_default=False)

        # Adding field 'Page._page_title'
        db.add_column(u'page_page', u'_page_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=69, blank=True),
                      keep_default=False)

        # Adding field 'Page._content_title'
        db.add_column(u'page_page', u'_content_title',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
