...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'medialibrary_category', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'children', null=True, to=orm['medialibrary.Category'])),
        ...
        db.create_table(u'medialibrary_mediafiletranslation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'translations', to=orm['medialibrary.MediaFile'])),
    ...
    models = {
        ...
        u'medialibrary.mediafiletranslation': {
            'Meta': {'unique_together': "((u'parent', u'language_code'),)", 'object_name': 'MediaFileTranslation'},
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'translations'", 'to': u"orm['medialibrary.MediaFile']"})
        }
    }
