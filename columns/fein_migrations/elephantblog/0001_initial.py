...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'elephantblog_categorytranslation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'translations', to=orm['elephantblog.Category'])),
        ...
        db.create_table(u'elephantblog_entry', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'blogentries', to=orm['auth.User'])),
        ...
        db.create_table(u'elephantblog_entry_richtextcontent', (
            ...
            (u'parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'richtextcontent_set', to=orm['elephantblog.Entry'])),
        ...
        db.create_table(u'elephantblog_entry_mediafilecontent', (
            ...
            (u'parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'mediafilecontent_set', to=orm['elephantblog.Entry'])),
            (u'region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            (u'ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
    ...
    models = {
        ...
        u'elephantblog.category': {
            'Meta': {'ordering': "[u'ordering']", 'object_name': 'Category'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ordering': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'})
        },
        u'elephantblog.categorytranslation': {
            'Meta': {'ordering': "[u'title']", 'object_name': 'CategoryTranslation'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'default': "'af'", 'max_length': '10'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'translations'", 'to': u"orm['elephantblog.Category']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'elephantblog.entry': {
            'Meta': {'ordering': "[u'-published_on']", 'object_name': 'Entry'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'blogentries'", 'to': u"orm['auth.User']"}),
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'blogentries'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['elephantblog.Category']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'elephantblog.mediafilecontent': {
            'Meta': {'ordering': "[u'ordering']", 'object_name': 'MediaFileContent', 'db_table': "u'elephantblog_entry_mediafilecontent'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            u'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'mediafilecontent_set'", 'to': u"orm['elephantblog.Entry']"}),
        ...
        u'elephantblog.richtextcontent': {
            'Meta': {'ordering': "[u'ordering']", 'object_name': 'RichTextContent', 'db_table': "u'elephantblog_entry_richtextcontent'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'richtextcontent_set'", 'to': u"orm['elephantblog.Entry']"}),
            u'region': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
